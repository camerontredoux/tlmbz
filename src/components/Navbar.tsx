      ...
      <nav className="p-6">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          {/* <div className="hidden items-center gap-4 sm:flex">
            <div className="flex overflow-x-hidden rounded-md border border-[#30303F] bg-[#1D1D27]">
              <button className="btn-nav border-r">Chat</button>
              <button className="btn-nav flex items-center border-r">
                <FiPlus className="mr-1 text-gray-400" /> Add Screenshot
              </button>
              <button className="btn-nav flex items-center">
                <TbDotsVertical />
              </button>
            </div>
            <button>
            ...
            <button className="flex items-center rounded-full bg-white p-[5px]">
              <Image
                alt="Default Avatar"
                width={16}
                height={16}
